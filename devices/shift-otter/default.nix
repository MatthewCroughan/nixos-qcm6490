{ inputs, ... }:
{
  perSystem =
    ...
    {
      packages.qcm6490-shift-otter-uboot-bootimg =
        let
          uboot = pkgs.ubootQCM6490ShiftOtter;
        in
        pkgs.runCommand "qcm6490-shift-otter-uboot-bootimg"
          {
          ...
          ''
            ...
            mkbootimg \
              ...
              -o $out
          '';
      packages.qcm6490-shift-otter-linux-bootimg =
        pkgs.runCommand "qcm6490-shift-otter-linux-bootimg"
          {
            nativeBuildInputs = with pkgs; [
              android-tools
            ];
